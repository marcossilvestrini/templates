...
Aquí tienes una plantilla en blanco para empezar: Para evitar volver a escribir demasiada información. Haga una búsqueda y reemplace con su editor de texto lo siguiente:`marcossilvestrini`,`templates`,`mrsilvestrini`,`marcossilvestrini`,`gmail`,`marcos.silvestrini`,`Templates`,`Project for publish template for all tools and languages`
...
Enlace del proyecto:<https://github.com/marcossilvestrini/templates>
...
-   [Plantilla Github por othneildrew](https://github.com/othneildrew/Best-README-Template)
-   [Plantillas de Git gitignore](https://github.com/github/gitignore)
-   [Insignias de Git](https://github.com/Ileriayo/markdown-badges#usage)
-   [Flujos de trabajo de Github](https://docs.github.com/en/actions/using-workflows/about-workflows)
