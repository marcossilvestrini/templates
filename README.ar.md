...
إليك نموذج فارغ للبدء: لتجنب إعادة كتابة الكثير من المعلومات. قم بالبحث واستبداله بمحرر النصوص الخاص بك لما يلي:`marcossilvestrini`,`templates`,`mrsilvestrini`,`marcossilvestrini`,`gmail`,`marcos.silvestrini`,`Templates`,`Project for publish template for all tools and languages`
...
استخدم هذه المساحة لعرض أمثلة مفيدة لكيفية استخدام المشروع. تعمل لقطات الشاشة الإضافية وأمثلة التعليمات البرمجية والعروض التوضيحية بشكل جيد في هذا المجال. يمكنك أيضًا الارتباط بمزيد من الموارد.
...
انظر[القضايا المفتوحة](https://github.com/marcossilvestrini/templates/issues)للحصول على قائمة كاملة بالميزات المقترحة (والمشكلات المعروفة).
...
ماركوس سيلفستريني -[@mrsilvestrini](https://twitter.com/mrsilvestrini)-[ماركوس.سيلفسترن@جميل.كوم](mailto:marcos.silvestrini@gmail.com)

رابط المشروع:[هتبص://جذب.كوم/ماركسيلفصترن/تمبلتص](https://github.com/marcossilvestrini/templates)
...
-   [قالب جيثب بواسطة othneildrew](https://github.com/othneildrew/Best-README-Template)
-   [قوالب جيت gitignore](https://github.com/github/gitignore)
-   [شارات جيت](https://github.com/Ileriayo/markdown-badges#usage)
-   [سير عمل جيثب](https://docs.github.com/en/actions/using-workflows/about-workflows)
